...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    decline: "Refuser",
    meetingInvitation: {
        title: "{name} vous invite à rejoindre la réunion",
        invitationDeclined: "Votre invitation a été refusée par {name}",
    ...
    roomInvitation: {
        notification: "Vous avez été invité dans la room {roomName}",
        notificationTitle: "Nouvelle invitation",
        unknownRoom: "Une room",
    },
    suggestedRooms: "Salons recommandés",
    ignoreSuggestedRoom: "Ignorer",
    ...
    thread: {
        ...
        tabLabel: "Fils",
        empty: "Aucun fil pour l'instant",
        defaultPreview: "Fil de discussion",
        replySingular: "1 réponse",
    ...
    poll: {
        ...
        multiSelect: "Jusqu'à {count} choix",
        ...
        kind: {
            ...
            generic: "Sondage clôturé.",
            withWinner: "Sondage clôturé. Réponse en tête : {answer}",
        },
        create: {
            title: "Créer un sondage",
            description: "Créer un sondage dans cette discussion.",
            question: "Question",
            questionPlaceholder: "Posez une question",
            answers: "Réponses",
            addAnswer: "Ajouter une réponse",
            answerPlaceholder: "Réponse {index}",
            answerCount: "{count}/{max} réponses prêtes",
            visibility: "Visibilité",
            openDescription: "Les résultats sont visibles après votre vote.",
            closedDescription: "Les résultats restent cachés jusqu'à la clôture.",
            cancel: "Annuler",
            submit: "Créer le sondage",
            validationError: "Saisissez une question et au moins 2 réponses.",
            submitError: "Impossible de créer le sondage. Veuillez réessayer.",
        },
    },
    file: {
