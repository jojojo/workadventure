...
export const EXTERNAL_PRESENCE_URL = env.EXTERNAL_PRESENCE_URL;
export const EXTERNAL_PRESENCE_AUTH_TOKEN = env.EXTERNAL_PRESENCE_AUTH_TOKEN;
export const EXTERNAL_PRESENCE_MATCH_FIELD = env.EXTERNAL_PRESENCE_MATCH_FIELD || "identifier";
export const EXTERNAL_PRESENCE_POLL_INTERVAL = env.EXTERNAL_PRESENCE_POLL_INTERVAL;
export const THREE_CX_BASE_URL = env.THREE_CX_BASE_URL;
export const THREE_CX_CLIENT_ID = env.THREE_CX_CLIENT_ID;
export const THREE_CX_CLIENT_SECRET = env.THREE_CX_CLIENT_SECRET;
export const THREE_CX_MATCH_FIELD = env.THREE_CX_MATCH_FIELD || "identifier";
export const THREE_CX_USER_FILTER_FIELD = env.THREE_CX_USER_FILTER_FIELD || "EmailAddress";
export const THREE_CX_ACTIVE_CALLS_PATH = env.THREE_CX_ACTIVE_CALLS_PATH || "/xapi/v1/ActiveCalls";
...
export const FRONT_ENVIRONMENT_VARIABLES: FrontConfigurationInterface = {
    ...
    ENABLE_CHAT_UPLOAD,
    FALLBACK_LOCALE,
    EXTERNAL_PRESENCE_ENABLED:
        !!EXTERNAL_PRESENCE_URL || !!(THREE_CX_BASE_URL && THREE_CX_CLIENT_ID && THREE_CX_CLIENT_SECRET),
